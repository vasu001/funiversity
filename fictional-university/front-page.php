...
<div class="full-width-split group">
  <div class="full-width-split__one">
    <div class="full-width-split__inner">
      <h2 class="headline headline--small-plus t-center"><?php _e('Upcoming Events', 'funiversity'); ?></h2>
      <?php
          $today = date('Ymd');
  ...
  <div class="full-width-split__two">
    <div class="full-width-split__inner">
      <h2 class="headline headline--small-plus t-center"><?php _e('From Our Blogs', 'funiversity'); ?></h2> 
      <?php
        $headerBlogs = new WP_Query([
          'posts_per_page' => 2,
          'post_type' => 'post'
        ]);
        while($headerBlogs->have_posts(  )):
          $headerBlogs->the_post(); ?>
